...
wget http://dl.google.com/linux/chrome/deb/pool/main/g/google-chrome-stable/google-chrome-stable_130.0.6723.58-1_amd64.deb > /dev/null 2>&1
sudo dpkg -i google-chrome-stable_130.0.6723.58-1_amd64.deb > /dev/null 2>&1
